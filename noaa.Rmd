...
```{r statistics}
econ_damage <- econ_df %>% group_by(YEAR, event) %>% 
        summarize(average_crop_damage = mean(units_adj_cropdmg),
                  median_crop_damage = median(units_adj_cropdmg),
                  total_crop_damage = sum(units_adj_cropdmg),
                  average_property_damage = mean(units_adj_propdmg),
                  median_property_damage = median(units_adj_propdmg),
                  total_property_damage = sum(units_adj_propdmg) )
