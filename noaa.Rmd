...
* Create a new data set and subset to the top 5 most damaging weather types
* Change event to a factor variable
* Filter the data set to include only the top 5 most damaging weather types
* Create a line plot 
* The y axix is total property damage in log(millions of dollars).  Note that the damage from Hurricane Katrina in 2005 is so much larger that it was necessary to change to a log scale.
